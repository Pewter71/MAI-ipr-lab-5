...
describe('Chat Server', () => {
  ...
  describe('Socket.IO Connection', () => {
    ...
    it('should send message history on connection', (done) => {
      const mockMessages = [
        JSON.stringify({ id: 1, username: 'Test', text: 'Hello', timestamp: Date.now() }),
        JSON.stringify({ id: 2, username: 'User', text: 'World', timestamp: Date.now() })
      ];
    ...
    it('should handle redis error when fetching history', (done) => {
    ...
    it('should handle malformed messages in history', (done) => {
      const mockMessages = [
        JSON.stringify({ id: 1, username: 'Test', text: 'Valid', timestamp: Date.now() }),
        'invalid json',
        JSON.stringify({ id: 2, username: 'User', text: 'Also valid', timestamp: Date.now() })
      ];
  ...
  describe('Message Sending', () => {
    ...
    it('should save message to Redis', (done) => {
      ...
      clientSocket.on('message:new', () => {
        ...
        expect(mockRedisClient.lTrim).toHaveBeenCalledWith('chat:messages', 0, 49);
        done();
      });
    ...
    it('should handle Redis error when saving message', (done) => {
  ...
  describe('Server Lifecycle', () => {
    it('should create server with default options', () => {
      ...
      expect(defaultServer).toHaveProperty('pubClient');
      expect(defaultServer).toHaveProperty('subClient');
